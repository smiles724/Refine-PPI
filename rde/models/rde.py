...
class CircularSplineRotamerDensityEstimator(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        # Encoding
        self.single_encoder = PerResidueEncoderV1(feat_dim=cfg.encoder.node_feat_dim, max_num_atoms=5,  # N, CA, C, O, CB,
                                                )
        self.masked_bias = nn.Embedding(num_embeddings=2, embedding_dim=cfg.encoder.node_feat_dim, padding_idx=0, )
