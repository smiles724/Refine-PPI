...
class RandomMaskAminoAcids(object):
    ...
    def __init__(self, mask_ratio_in_all=0.05, ratio_in_maskable_limit=0.5, mask_token=20, maskable_flag_attr='core_flag', mask_ratio_mode='constant', ):
        super().__init__()
        ...
        self.maskable_flag_attr = maskable_flag_attr               # only mask residues in the core subset
