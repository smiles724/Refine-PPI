...
from rde.utils.skempi import SkempiDatasetManager, per_complex_corr, eval_skempi_three_modes
...
if __name__ == '__main__':
    ...
    logger.info(f'Loading datasets (ESM2 embeddings: {config.data.use_plm})...')
    ...
    def train(it):
        ...
        logstr = '[train] Iter %05d | loss_ddg %.2f | fold %.0f' % (it, loss_dict['regression'].item(), fold)
