...
from .irr_repr import (irr_repr, rot_to_euler_angles)
from .utils import (torch_default_dtype, cache_dir, exists, default, to_order, l2norm, slice_for_centering_y_to_x)
...
RANDOM_ANGLES = torch.tensor(
    [[4.41301023, 5.56684102, 4.59384642], [4.93325116, 6.12697327, 4.14574096], [0.53878964, 4.09050444, 5.36539036], [2.16017393, 3.48835314, 5.55174441],
        [2.52385107, 0.2908958, 3.90040975]], dtype=torch.float64)
